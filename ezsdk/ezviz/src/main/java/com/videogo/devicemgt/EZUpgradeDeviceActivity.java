...
//                            showUpgradeSuccess();
        ...
        Thread thr = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    mUpgradeStatus = RootActivity.getOpenSDK().getDeviceUpgradeStatus(mDeviceSerial);
    ...
    private void startUpgrade() {
        ...
        Thread thr = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    RootActivity.getOpenSDK().upgradeDevice(mDeviceSerial);
                    mTimer = new Timer();
                    mTimer.schedule(new TimerTask() {
                        @Override
                        public void run() {
    ...
    private void showVersionViewOnce() {
        ...
        Thread thr = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    mVersion = RootActivity.getOpenSDK().getDeviceVersion(mDeviceSerial);

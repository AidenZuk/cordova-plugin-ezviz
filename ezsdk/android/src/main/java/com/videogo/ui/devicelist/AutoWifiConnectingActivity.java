...
//                            LocalInfo.getInstance().setWifiPassword(mac, wifiPassword);
        ...
        getOpenSDK().startConfigWifi(AutoWifiConnectingActivity.this, serialNo, wifiSSID, wifiPassword, mEZStartConfigWifiCallback);
    }
...
//                        if (!TextUtils.isEmpty(mVerifyCode)) {
//                            //保存密码
//                            getOpenSDK().setValidateCode(mVerifyCode, serialNo);
//                        }
